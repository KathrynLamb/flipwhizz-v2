...
//         {/* 
//           ================================================
//           NO PAGE-LEVEL HEADER HERE — StoryHeader in 
//           StoryJourneyShell (layout.tsx) handles nav.
//           ================================================
//         */}
  
//         {/* SPREAD NAVIGATOR — stays as a compact inline bar */}
...
//                   {/* GENERATE BUTTON — always visible so they can regenerate */}
//                   <button
...
//                   {/* 
//                     ============================================
//                     THE PAYWALL CTA — appears only after sample 
//                     is generated. This is the wow → convert 
//                     moment.
//                     ============================================
//                   */}
//                   {sampleUrl && !isGeneratingSample && (
...
//                       {/* Micro-reassurance under the button */}
...
//           Key UX decisions:
//           - Show the sample illustration prominently (reminder 
//             of the wow moment)
//           - Show blurred "ghost" spreads to tease what they're 
//             unlocking — creates anticipation
//           - Clear pricing with what's included
//           - PayPal as the only payment method (already integrated)
//           ==================================================
//         */}
//         <AnimatePresence>
//           {showPayment && (
...
//                   {/* SAMPLE + BLURRED TEASE GRID */}
//                   <div className="mb-6">
//                     <div className="grid grid-cols-3 gap-2">
//                       {/* The real sample — full color, prominent */}
...
//                       {/* Ghost spreads row — 3 small locked placeholders */}
//                       {[1, 2, 3].map((i) => (
//                         <div
//                           key={i}
...
//                                 storyId: style.storyId, // ← pass storyId so capture can mark story as paid
//                               }),
//                             });
...
//                             if (result.success) {
//                               // Small delay so user sees "Processing" state
