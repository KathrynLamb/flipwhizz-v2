            ...
            >
              ...
              <div className="px-6 pb-6 pt-2 flex gap-3">
                    <button
                      ...
                      className="flex-1 rounded-2xl py-4 font-semibold text-gray-700 bg-gray-100 hover:bg-gray-200 active:scale-[0.98] transition-all text-sm"
                    >
                      Make changes
                    </button>
                    ...
                    <button
                      ...
                      className="flex-1 rounded-2xl py-4 font-bold bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white shadow-lg active:scale-[0.98] transition-all text-sm"
                    >
                      Confirm ✓
                    </button>
                  </div>
