...
//     // Since the frontend didn't pass storyId, we find the most recently updated story 
...
//     // Here we use Base64 to strictly follow your existing pattern.
...
//         updatedAt: new Date(),
//         // We also implicitly unlock the character if it was locked? 
//         // Logic says no, usually we only generate if unlocked.
//       })
//       .where(eq(characters.id, characterId));
