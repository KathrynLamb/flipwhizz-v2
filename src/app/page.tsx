...
export default async function Home() {
  ...
  return (
    <main className={`min-h-screen ${playfair.variable} ${lato.variable} font-sans bg-white text-slate-900 overflow-x-hidden`}>
      ...
      <section className="relative w-full flex flex-col bg-white">
        ...
        <div className="relative w-full">
          <div className="hidden md:block relative w-full" style={{ height: "min(75vh, 700px)" }}>
            <Image src="/LandingPage/hero-new201.jpg" alt="Big Imaginations Deserve Beautiful Books" fill priority className="object-cover object-top" />
          </div>
      ...
      <section className="pt-4 pb-12 md:pt-6 md:pb-16 bg-white">
        <div className="flex flex-col items-center gap-4 px-6">
          <Link
            ...
            className="group px-10 py-4 md:px-14 md:py-5 rounded-full text-base md:text-lg font-bold text-white tracking-wide transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-[0.98]"
            style={{ background: "#D94590", boxShadow: "0 6px 24px rgba(217,69,144,0.3)" }}
          >
            {hasProjects ? "Create Another Story" : "Create Your First Story"}
          </Link>
          <div className="text-center space-y-1">
            <p className="text-sm md:text-base text-gray-600 font-medium">See your first illustrated spread for free — no card, no commitment.</p>
            <p className="text-xs md:text-sm text-gray-400">The whole thing takes about 5 minutes.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28 px-6 md:px-12 bg-[#FDF8F0]">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-12">
            <h2 className="font-serif text-4xl md:text-5xl text-[#261C15] font-bold">This Is Olivia&apos;s Book. No One Else&apos;s.</h2>
            <p className="mt-4 text-lg text-[#6B5D52]">Your photos. Your words. Their one-of-a-kind book.</p>
          </div>
      ...
      <section id="pricing" className="py-28 px-6 md:px-12 bg-[#FDF8F0] relative overflow-hidden">
        <div className="mx-auto max-w-6xl">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="font-serif text-4xl md:text-5xl text-[#261C15] font-bold">Simple, Honest Pricing</h2>
            <p className="mt-6 text-lg text-[#6B5D52] leading-relaxed">Each story is crafted once, then yours forever.<br />No subscriptions. No upsells. Just a beautiful book.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 items-stretch">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm flex flex-col hover:shadow-lg transition-shadow duration-300">
              ...
              <ul className="space-y-3 text-sm text-[#4A4038] mb-8">
                {["Fully personalised story", "Custom illustrations", "Unlimited re-reads", "High-quality PDF download"].map(f => (
                  <li key={f} className="flex items-start gap-2"><span style={{ color: "#D94590" }} className="mt-0.5">✦</span>{f}</li>
                ))}
              </ul>
            ...
            {/* PRINTED */}
            <div className="rounded-2xl border-2 bg-white p-10 shadow-xl relative flex flex-col hover:shadow-2xl transition-shadow duration-300 md:-mt-4 md:mb-[-16px]" style={{ borderColor: "#D94590" }}>
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 text-white text-xs font-semibold px-4 py-1 rounded-full" style={{ background: "#D94590" }}>Most Loved</div>
              <h3 className="font-serif text-2xl font-bold mb-2" style={{ color: "#2D2235" }}>Printed Storybook</h3>
              <p className="text-sm text-[#6B5D52] mb-6">A keepsake to hold, gift, and treasure for years.</p>
              <div className="mb-6"><span className="text-4xl font-serif font-bold text-[#261C15]">£29</span><span className="text-[#6B5D52]"> one-off</span></div>
              <ul className="space-y-3 text-sm text-[#4A4038] mb-8">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm flex flex-col hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="mb-6"><span className="text-4xl font-serif font-bold text-[#261C15]">£39</span><span className="text-[#6B5D52]"> one-off</span></div>
              <ul className="space-y-3 text-sm text-[#4A4038] mb-8">
